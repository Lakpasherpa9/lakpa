...
<main>
    ...
    <section class="experience-outdoors">
        <div class="container">
            ...
            <h1>Paragliding</h1>
                <p>Paragliding is the recreational and competitive adventure sport of flying paragliders: lightweight, free-flying with no rigid primary structure.</p>
                </div>
            ...
            <div class="activities-grid-item camping">
                            ...
                            <h1>Camping</h1>
                            <p>Camping is an outdoor activity involving overnight stays away from home with or without a shelter, such as a tent or a recreational vehicle.</p>
            </div>
            <div class="activities-grid-item rafting">
                            <i class="icon ion-md-bonfire"></i>
                            <h1>Rafting</h1>
                            <p>Rafting and whitewater rafting are recreational outdoor activities which use an inflatable raft to navigate a river or other body of water</p>
            </div>
            </div>
        </div>
    </section>
    ...
    <section class="begin-adventure">
        <div class="container">
            <div class="title-heading">
                ...
                <p>Gear up and start going to places </p>
            </div>
    </section>
    <!-- <img src="./images/pic01.jpg" width="85%" height="1%" style="margin-left: 5%"> -->
    <!-- Covid Section -->
    <hr>
